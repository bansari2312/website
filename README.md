...
<head>
  ...
  <meta name="description" content="bansari rathod's Portfolio - Tech Enthusiast | Motivator | Hustler. Explore my projects, skills, and experience.">
  <meta name="author" content="bansari rathod">
  <meta property="og:title" content="bansari rathod | Portfolio">
  <meta property="og:description" content="Explore bansari rathod's portfolio showcasing his skills, projects, and accomplishments in tech and motivation.">
  <meta property="og:image" content="bansari.jpg">
  <meta property="og:url" content="https://bansarirathod.com">
  <title>bansari rathod| Portfolio</title>
...
<body>
  ...
  <nav class="nav-bar fixed top-0 w-full shadow-lg z-50">
    <div class="max-w-7xl mx-auto flex items-center justify-between p-6">
      <h1 class="text-3xl font-bold text-teal-400">BANSARI RATHOD</h1>
  ...
  <header class="text-center py-32 bg-gradient-to-r from-teal-600 to-teal-800">
    <h1 class="text-5xl font-extrabold text-white">BANSARI RATHOD</h1>
  ...
  <section class="flex flex-col items-center justify-center py-16">
    <img src="bansari.jpg" alt="Bansari" class="rounded-full w-64 h-80 object-cover border-8 border-teal-400 shadow-lg scale-reveal">
  ...
  <footer class="footer py-8">
    <div class="max-w-6xl mx-auto flex justify-between items-center">
      <p class="text-lg text-gray-300">© 2025 Bansari Rathod</p>
      <div class="space-x-4">
        <a href="www.linkedin.com" class="social-icon text-2xl text-teal-400"><i class="fab fa-linkedin"></i></a>
        ...
        <a href="https://www.instagram.com" class="social-icon text-2xl text-teal-400"><i class="fab fa-instagram"></i></a>
